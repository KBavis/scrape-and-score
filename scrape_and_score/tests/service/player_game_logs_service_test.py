...
@patch('service.player_game_logs_service.fetch_data.fetch_player_game_log_by_pk', return_value = {"player_id": 12, "week": 12, "year": 2024})
...
@patch('service.player_game_logs_service.fetch_data.fetch_player_game_log_by_pk', return_value = None)
...
@patch('service.player_game_logs_service.fetch_data.fetch_player_game_log_by_pk', return_value = None)
def test_is_game_log_persisted_calls_expected_functions(mock_fetch_player_game_log_by_pk): 
...
def test_remove_previously_inserted_games_skips_removal_when_not_recent_games(mock_get_player_id, mock_extract_year, mock_is_game_log_persisted):
   data = {
      'week': [1, 2],
   ...
   player_metrics = [{'player': 'My Player', 'player_metrics': pd.DataFrame(data=data)}]
...
@patch('service.player_game_logs_service.service_util.extract_year_from_date', return_value=2024)
@patch('service.player_game_logs_service.get_player_id_by_name', return_value = 14)
def test_remove_previously_inserted_games_calls_expected_functions(mock_get_player_id, mock_extract_year, mock_is_game_log_persisted):
   data = {
      'week': [1],
      'date': ['2024-09-10'],
      'game_location': ['@'],
...
@patch('service.player_game_logs_service.is_game_log_persisted', return_value = True) # game logs persisted, so should remove
@patch('service.player_game_logs_service.service_util.extract_year_from_date', return_value=2024)
@patch('service.player_game_logs_service.get_player_id_by_name', return_value = 14)
def test_remove_previously_inserted_games_deletes_entries_from_player_metrics(mock_get_player_id, mock_extract_year, mock_is_game_log_persisted): 
   data = {
      'week': [1],
      'date': ['2024-09-10'],
      'game_location': ['@'],
...
@patch('service.player_game_logs_service.is_game_log_persisted', return_value = False) # game logs NOT persisted, so shouldn't remove
@patch('service.player_game_logs_service.service_util.extract_year_from_date', return_value=2024)
@patch('service.player_game_logs_service.get_player_id_by_name', return_value = 14)
def test_remove_previously_inserted_games_wont_delete_entries_from_player_metrics(mock_get_player_id, mock_extract_year, mock_is_game_log_persisted): 
   data = {
      'week': [1],
      'date': ['2024-09-10'],
      'game_location': ['@'],
...
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value=None)
def test_insert_multiple_players_game_logs_skips_insertion_when_previosuly_persisted(mock_remove, mock_get_player_id, mock_insert_qb, mock_insert_rb, mock_insert_wr):
...
@patch('service.player_game_logs_service.insert_data.insert_qb_player_game_logs')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_skips_insertion_when_game_logs_already_persisted(mock_remove, mock_insert_qb_game_logs, mock_get_qb_game_log_tuples, mock_get_player_id_by_name):
   player_game_logs_service.insert_multiple_players_game_logs([], [])
...
@patch('service.player_game_logs_service.insert_data.insert_qb_player_game_logs')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_calls_expected_functions_when_position_is_qb(mock_remove, mock_insert_qb_game_logs, mock_get_qb_game_log_tuples, mock_get_player_id_by_name): 
...
@patch('service.player_game_logs_service.insert_data.insert_rb_player_game_logs')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_calls_expected_functions_when_position_is_rb(mock_remove, mock_insert_rb_game_logs, mock_get_rb_game_log_tuples, mock_get_player_id_by_name):
   mock_df = pd.DataFrame(data = [{'Hi'}])
   depth_charts = []
...
@patch('service.player_game_logs_service.insert_data.insert_wr_or_te_player_game_logs')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_calls_expected_functions_when_position_is_wr_or_te(mock_remove, mock_insert_wr_game_logs, mock_get_wr_game_log_tuples, mock_get_player_id_by_name): 
   mock_df = pd.DataFrame(data = [{'Hi'}])
   depth_charts = []
...
@patch('service.player_game_logs_service.get_player_id_by_name')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_raises_exception_when_unknown_posiiton_found(mock_remove, mock_get_player_id):
   mock_df = pd.DataFrame(data = [{'Hi'}])
   depth_charts = []
   invalid_position = 'OL'
...
@patch('service.player_game_logs_service.get_player_id_by_name')
@patch('service.player_game_logs_service.remove_previously_inserted_games', return_value = None)
def test_insert_multiple_player_game_logs_skips_players_with_empty_metrics(mock_remove, mock_get_player_id, mock_insert_qb, mock_insert_rb, mock_insert_wr):
