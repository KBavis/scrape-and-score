...
def test_get_team_id_by_name_returns_expected_id_when_name_persisted(mock_fetch_team_by_name):
   expected_team_id = 12
...
@patch('service.team_service.fetch_data.fetch_team_by_name')
def test_get_team_id_by_name_returns_none_when_name_not_persisted(mock_fetch_team_by_name):
