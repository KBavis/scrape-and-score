...
def test_get_all_players_returns_expected_players_when_persisted(
    mock_fetch_all_players,
):
    expected_players = [
        {"name": "Anthony Richardson", "position": "QB"},
        {"name": "Jonathon Taylor", "position": "RB"},
    ]
...
def test_get_all_players_returns_expected_players_when_none_persisted(
    mock_fetch_all_players,
):
