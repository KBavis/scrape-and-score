...
def test_extract_home_team_from_game_location_returns_expected_flag_when_not_home():
    expected_flag = "F"
    game_location = "@"
    assert expected_flag == service_util.extract_home_team_from_game_location(
        game_location
    )
...
def test_get_team_name_by_pfr_acronym_returns_expected_team_when_found(mock_get_config):
    ...
    mock_get_config.return_value = [
        {"name": expected_name, "pfr_acronym": "IND"},
        {"name": "Random", "pfr_acronym": "RAN"},
    ]
