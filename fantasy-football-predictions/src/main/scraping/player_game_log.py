...
'''
All credit for the following code in this module goes to the developer https://github.com/mjk2244. 
The code within their created library (https://github.com/mjk2244/pro-football-reference-web-scraper) 
does not utilize a proxy, causing the website we are attempting to scrape to block our requests. 

TODO: Move this code into a seperate folder (i.e a PFR folder that store our scraper and this utility module)
'''
